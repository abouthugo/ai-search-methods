...
public class GreedySearch {
    ...
    private GreedySearch bestFirstSearch;
    ...
    public static void main(String... arg) {
        ...
        try {
            System.out.println("Enter the number of states to visit: ");
            ...
            source = scan.nextInt();
            System.out.println("The states are visited as follows: ");
            GreedySearch bestFirstSearch = new GreedySearch(number_of_vertices);
